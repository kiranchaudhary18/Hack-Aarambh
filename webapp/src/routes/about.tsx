      ...
      <section className="relative mx-auto w-[min(1180px,94%)] pt-12">
        <FadeIn>
          ...
          <h1 className="mt-4 font-display text-5xl font-bold sm:text-6xl">
            We protect <span className="text-gradient">first-time job seekers</span> from scams.
          </h1>
          <p className="mt-5 max-w-2xl text-lg text-muted-foreground">
            Every year, millions of students and freshers lose money to fake recruiters, advance-fee
            fraud, and brand impersonation. ScamSniff is a free tool that puts AI-powered fraud
            detection in their pocket.
          </p>
        </FadeIn>
          ...
          {[
            {
              icon: Target,
              t: "The problem",
              d: "Job scams cost victims $367M+ in 2024 alone. Most look identical to real offers.",
              c: "var(--clay-pink)",
            },
            {
              icon: ShieldCheck,
              t: "Our solution",
              d: "Paste any offer — text, PDF, or URL. Get a scam score and red-flag breakdown in 4 seconds.",
              c: "var(--clay-green)",
            },
            {
              icon: Sparkles,
              t: "Our vision",
              d: "A world where no one has to learn about scams the hard way. Free education + free protection.",
              c: "var(--clay-purple)",
            },
          ].map(({ icon: I, t, d, c }) => (
        ...
        <FadeIn delay={0.1}>
          <div className="clay-lg mt-14 p-10">
            ...
            <p className="mt-3 max-w-2xl text-muted-foreground">
              ScamSniff started as a hackathon weekend in 2026. Today it's maintained by a small
              team of designers, ML engineers, and cybersecurity researchers who care deeply about
              consumer safety.
            </p>
            <div className="mt-8 grid gap-5 sm:grid-cols-2 md:grid-cols-4">
              {[
                ...
                <div key={m.n} className="clay-sm p-5 text-center">
                  <div
                    className="mx-auto grid h-16 w-16 place-items-center rounded-2xl font-bold"
