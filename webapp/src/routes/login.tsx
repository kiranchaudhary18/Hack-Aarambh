...
import { ShieldCheck, Mail, Lock, ArrowRight, Eye, EyeOff, Shield, Radio, CheckCircle, Activity, Sparkles, AlertTriangle, Check, Loader2 } from "lucide-react";
...
function Login() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      if (blobs) {
        gsap.to(blobs[0], { x: "15vw", y: "10vh", duration: 18, repeat: -1, yoyo: true, ease: "sine.inOut" });
        gsap.to(blobs[1], { x: "-12vw", y: "-15vh", duration: 22, repeat: -1, yoyo: true, ease: "sine.inOut" });
        gsap.to(blobs[2], { x: "8vw", y: "-10vh", duration: 16, repeat: -1, yoyo: true, ease: "sine.inOut" });
      }
      ...
      if (shieldRef.current) {
        gsap.to(shieldRef.current, { y: -8, duration: 2.8, repeat: -1, yoyo: true, ease: "sine.inOut" });
      }
      if (statsCardRef.current) {
        gsap.to(statsCardRef.current, { y: 6, x: -3, duration: 3.5, repeat: -1, yoyo: true, ease: "sine.inOut", delay: 0.3 });
      }
      if (chartCardRef.current) {
        gsap.to(chartCardRef.current, { y: -6, x: 4, duration: 3, repeat: -1, yoyo: true, ease: "sine.inOut", delay: 0.8 });
      }
      if (floatCard1Ref.current) {
        gsap.to(floatCard1Ref.current, { y: -10, duration: 4, repeat: -1, yoyo: true, ease: "sine.inOut", delay: 0.5 });
      }
      if (floatCard2Ref.current) {
        gsap.to(floatCard2Ref.current, { y: 8, duration: 3.8, repeat: -1, yoyo: true, ease: "sine.inOut", delay: 1.2 });
      }

      // Entrance animation for login card
      gsap.fromTo(".login-card-container",
  ...
  return (
    <div className="relative min-h-screen lg:h-screen lg:overflow-hidden w-full bg-[oklch(0.97_0.018_95)] font-space flex items-center justify-center p-3 sm:p-5 lg:p-6">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center lg:h-full py-2 lg:py-0">
        ...
        <div ref={leftColRef} className="lg:col-span-6 flex flex-col justify-center space-y-4 lg:space-y-5 animate-left-hero px-2 lg:px-4 py-4 lg:py-0 relative">
          ...
          <div className="inline-flex self-start items-center gap-2 px-3 py-1 rounded-full bg-white/70 backdrop-blur-md border border-white/80 shadow-[inset_0_1px_3px_rgba(255,255,255,0.8),0_4px_12px_rgba(180,160,200,0.1)]">
            ...
            <span className="text-[10px] font-bold tracking-wide uppercase text-[oklch(0.4_0.1_270)] flex items-center gap-1 font-space">
              <Shield className="h-3.5 w-3.5 text-[oklch(0.62_0.18_295)]" /> Cyber Defense Spotlight Active
            </span>
          </div>
          ...
          <div className="space-y-2.5">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[oklch(0.24_0.04_270)] leading-[1.1] font-space">
              Scam<span className="text-gradient">Sniff</span> AI.<br />
              <span className="font-light text-[oklch(0.4_0.05_270)]">Zero Job Scams.</span><br />
              Total Protection.
            </h1>
            <p className="max-w-md text-sm sm:text-base text-[oklch(0.45_0.03_270)] font-sans font-medium leading-relaxed">
              Verify jobs, scan contracts, and detect fraud instantly with next-gen neural evaluation. Clean, premium cybersecurity built for smart workers.
            </p>
          </div>
          ...
          <div className="relative flex items-center justify-start h-[210px] sm:h-[230px] w-full max-w-lg mt-2">
            ...
            >
              <div className="w-28 h-28 sm:w-34 sm:h-34 rounded-full bg-white/90 shadow-[inset_8px_8px_16px_rgba(180,160,200,0.1),_inset_-8px_-8px_16px_rgba(255,255,255,0.9)] flex items-center justify-center relative overflow-hidden group">
                ...
                <ShieldCheck className="h-12 w-12 sm:h-16 sm:w-16 text-[oklch(0.62_0.18_295)] drop-shadow-[0_10px_20px_rgba(98,0,185,0.25)] relative z-10" strokeWidth={1.5} />
            ...
            >
              <div className="flex items-center justify-between">
                <span className="text-[9px] font-bold text-muted-foreground uppercase">Threat Index</span>
                <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-purple-50 text-[oklch(0.62_0.18_295)]">AI Monitored</span>
              </div>
              ...
              <div className="mt-2 h-11 w-full overflow-hidden relative">
                <svg viewBox="0 0 100 40" className="w-full h-full">
                  ...
                  <path d="M0 40 L0 30 Q15 15 30 25 T60 12 T85 20 Q92 5 100 8 L100 40 Z" fill="url(#chartGlow)" />
                  <path 
                  ...
                  />
                  <circle cx="100" cy="8" r="2.5" fill="oklch(0.62 0.18 295)" className="animate-ping" />
                  <circle cx="100" cy="8" r="2" fill="white" stroke="oklch(0.62 0.18 295)" strokeWidth="1.5" />
                </svg>
              </div>
            </div>
          ...
          >
            ...
            <div>
              <p className="text-[10px] font-extrabold text-[oklch(0.24_0.04_270)]">Scam Neutralized</p>
          ...
          >
            ...
            <div>
              <p className="text-[10px] font-extrabold text-[oklch(0.24_0.04_270)]">E2E Shield Active</p>
        ...
        <div className="lg:col-span-6 flex items-center justify-center p-0.5 sm:p-2 relative">
          ...
          <div className={`login-card-container w-full max-w-md relative transition-transform duration-300 ${shake ? "animate-[shake_0.5s_ease-in-out]" : ""}`}>
            ...
            <div className="w-full bg-white/75 backdrop-blur-[24px] rounded-[32px] p-5 sm:p-7.5 border border-white/80 shadow-[0_20px_50px_-12px_rgba(150,130,180,0.2),_inset_0_2px_4px_rgba(255,255,255,0.9),_inset_0_-2px_4px_rgba(180,160,200,0.08)] relative overflow-hidden">
              ...
              {isLoading && (
                <div className="absolute inset-0 bg-white/85 backdrop-blur-md z-30 flex flex-col items-center justify-center space-y-3.5 transition-all duration-300">
                  ...
                  <div className="text-center space-y-1">
                    <p className="text-xs font-extrabold text-[oklch(0.24_0.04_270)] tracking-wider uppercase font-space">Running Security Integrity Audit</p>
                    <p className="text-[10px] text-muted-foreground font-sans">Connecting to ScamSniff Neural Engine...</p>
                  </div>
                </div>
              )}
              ...
              {isSuccess && (
                <div className="absolute inset-0 bg-white/95 backdrop-blur-md z-30 flex flex-col items-center justify-center space-y-3 transition-all duration-300 animate-[fade-in_0.3s_ease-out]">
                  ...
                  <div className="text-center space-y-1">
                    <p className="text-sm font-extrabold text-[oklch(0.24_0.04_270)] font-space tracking-wide">Identity Verified Successfully</p>
                    <p className="text-[10px] text-muted-foreground font-sans">Launching secure ScamSniff dashboard session</p>
                  </div>
                </div>
              )}
