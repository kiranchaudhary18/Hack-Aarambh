...
import { LayoutDashboard, ScanSearch, History, BookOpen, User, ShieldCheck, LogOut, HelpCircle, Sparkles } from "lucide-react";
        ...
        <div className="space-y-4">
          ...
          <Link to="/" className="group flex items-center gap-2.5 px-2.5 py-1">
            <span className="grid h-10 w-10 place-items-center rounded-2xl clay-primary relative z-10 transition-transform duration-300 group-hover:scale-105 shadow-[0_8px_16px_-4px_rgba(120,80,200,0.25)]">
              <ShieldCheck className="h-5.5 w-5.5 text-white animate-[pulse_2.5s_infinite]" strokeWidth={2.5} />
            </span>
          ...
          <div className="mx-2.5 px-3 py-1.5 rounded-2xl bg-emerald-50/50 border border-emerald-500/10 flex items-center justify-between shadow-[inset_0_1.5px_2px_rgba(255,255,255,0.9)]">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[9px] font-bold text-emerald-800 font-space tracking-wider uppercase">Shield: Protected</span>
            </div>
            <span className="text-[8px] font-extrabold text-emerald-600 bg-white/80 px-1.5 py-0.5 rounded-md border border-emerald-500/10 shadow-sm">99.8%</span>
          </div>
            ...
            {items.map((it) => {
              ...
              return (
                ...
                >
                  ...
                  <Icon className={`h-5 w-5 transition-transform duration-300 ${hoveredTab === it.to ? "scale-110 rotate-3" : ""}`} strokeWidth={active ? 2.5 : 2.2} />
                  <span>{it.label}</span>
        ...
        <div className="space-y-4">
          ...
          <div className="mx-1 px-3.5 py-3 rounded-2xl bg-[oklch(0.97_0.01_95)] border border-[oklch(0.9_0.02_95)] shadow-[inset_1px_1px_2px_rgba(180,160,200,0.08),_inset_-1px_-1px_2px_rgba(255,255,255,0.8)]">
            <div className="flex items-center justify-between text-[9px] font-bold text-muted-foreground uppercase tracking-widest">
              ...
              <span className="text-[oklch(0.62_0.18_295)] font-extrabold font-space">Premium Free</span>
            </div>
            <p className="font-space text-[14.5px] font-extrabold text-[oklch(0.24_0.04_270)] mt-1.5">12 / 20 scans</p>
          ...
          <div className="space-y-2.5">
            ...
            <div className="flex items-center gap-3 px-2">
              ...
              <div className="flex flex-col min-w-0">
                <span className="font-space text-xs font-extrabold text-[oklch(0.24_0.04_270)] truncate">Aisha Khan</span>
                <span className="text-[9.5px] font-semibold text-muted-foreground truncate">aisha@scamsniff.ai</span>
              </div>
            </div>
