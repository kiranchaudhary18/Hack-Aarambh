...
export function PredictionDrift() {
  ...
  const predictionDriftData = accuracyData?.predictionDrift || [
    { date: "2024-01-01", accuracy: 0, falsePositiveRate: 0, falseNegativeRate: 0 },
    { date: "2024-01-02", accuracy: 0, falsePositiveRate: 0, falseNegativeRate: 0 },
    { date: "2024-01-03", accuracy: 0, falsePositiveRate: 0, falseNegativeRate: 0 },
    { date: "2024-01-04", accuracy: 0, falsePositiveRate: 0, falseNegativeRate: 0 },
    { date: "2024-01-05", accuracy: 0, falsePositiveRate: 0, falseNegativeRate: 0 },
  ];
